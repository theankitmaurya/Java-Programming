public class Why_Multiple_Inheritance_Is_Not_Supported_In_Java {
    public static void main(String[] args) {
        /*
         * Multiple inheritances face problems when there exists methods with same
         * signature in both the super classes.
         * Due to such problems, java does not support multiple inheritance directly,
         * but the similar concept can be achieved using interfaces.
        ...
        /*
         * Note ->
         * 1. Interfaces in JAVa is a bit like the class with a significant difference.
