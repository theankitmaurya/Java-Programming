public class Methods_Overloading {
    ...
    // void return type -> When we don't want our method to return anything, we use
    ...
    // static keyword -> Static keyword is used to associate a method of a given
    // class with the class rather than the object. Static method in a class is
    // shared by all the objects.
    public static void main(String[] args) {
        tellJoke();

        // Note: In case of arrays, the reference is passed. Same in the case for object
        // passing to methods.
